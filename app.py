...
url_get = requests.get('requests.get('https://www.coingecko.com/en/coins/ethereum/historical_data/?start_date=2020-01-01&end_date=2021-06-30', headers = { 'User-Agent': 'Popular browser\'s user-agent', })')
